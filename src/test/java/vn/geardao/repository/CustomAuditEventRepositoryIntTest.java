package vn.geardao.repository;

import vn.geardao.PhoneStatefulApp;
import vn.geardao.config.Constants;
import vn.geardao.config.audit.AuditEventConverter;
import vn.geardao.domain.PersistentAuditEvent;
...
import static vn.geardao.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
